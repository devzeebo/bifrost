...
declare function agent(options: ConfigureAgentOptions): (this: AgentContext) => Promise<void>;
//#endregion
...
//#endregion
//#region src/given/a_workspace.d.ts
declare const AGENTS_GWT_TMP_ROOT: string;
declare function a_workspace(this: AgentContext): Promise<void>;
declare function cleanup_workspace(this: AgentContext): Promise<void>;
//#endregion
//#region src/given/copy_to_workspace.d.ts
type CopyToWorkspaceOptions = {
  readonly from?: string;
  readonly base?: string;
};
declare function copy_to_workspace(workspace: string, globs: readonly string[], options?: CopyToWorkspaceOptions): Promise<void>;
//#endregion
//#region src/given/the_prompt.d.ts
declare function the_prompt(prompt: string): (this: AgentContext) => void;
//#endregion
//#region src/when/executing_the_agent.d.ts
declare function executing_the_agent(this: AgentContext): Promise<void>;
//#endregion
