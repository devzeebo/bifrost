import{r as i,d as k,e as T,n as C,j as e,i as N,a as A,b as P,o as E}from"../chunks/chunk-BpvDp_19.js";import{I as U}from"../chunks/chunk-hVb2WJRW.js";import{B as S}from"../chunks/chunk-Bhsx8EjT.js";import"../chunks/chunk-CQkiABwH.js";/* empty css                      *//* empty css                      */function D(){const[r,o]=i.useState(""),[l,n]=i.useState(""),[t,p]=i.useState(null),[a,h]=i.useState(!1),[f,b]=i.useState(!1),{showToast:c}=k(),g=i.useCallback(async()=>{if(!r.trim())return c("Error","Username is required","error"),!1;if(!l.trim())return c("Error","Realm name is required","error"),!1;h(!0);try{const m=await T.createAdmin({username:r.trim(),realm_name:l.trim(),create_sysadmin:!0,create_realm:!0});return p(m),!0}catch{return c("Error","Failed to create admin account","error"),!1}finally{h(!1)}},[r,l,c]),v=i.useCallback(async()=>{t?.pat&&(await navigator.clipboard.writeText(t.pat),b(!0),c("Copied!","PAT copied to clipboard","success"),setTimeout(()=>b(!1),2e3))},[t,c]),d=i.useCallback(()=>{C("/dashboard")},[]),s=["var(--color-red)","var(--color-blue)","var(--color-green)","var(--color-purple)"],u=[{title:"Admin Account",content:e.jsxs(y,{color:"var(--color-red)",children:[e.jsx(w,{color:"var(--color-red)",children:"Create Your Admin Account"}),e.jsx(j,{children:"This will be your primary administrator account for managing Bifrost."}),e.jsx(z,{label:"Username",value:r,onChange:o,placeholder:"Enter your username",disabled:a})]})},{title:"Create Realm",content:e.jsxs(y,{color:"var(--color-blue)",children:[e.jsx(w,{color:"var(--color-blue)",children:"Create Your First Realm"}),e.jsx(j,{children:"A realm is an isolated workspace for managing runes (issues, tasks, bugs)."}),e.jsx(z,{label:"Realm Name",value:l,onChange:n,placeholder:"e.g., my-project",disabled:a})]})},{title:"Access Token",content:e.jsxs(y,{color:"var(--color-green)",children:[e.jsx(w,{color:"var(--color-green)",children:"Your Personal Access Token"}),e.jsx(j,{children:"Save this token securely. You'll need it to authenticate with Bifrost."}),t?e.jsx(B,{pat:t.pat,copied:f,onCopy:v}):e.jsx("div",{className:"text-center py-8",children:e.jsx("p",{className:"text-sm opacity-60",children:"Click Next to generate your token..."})})]})},{title:"Complete",content:e.jsxs(y,{color:"var(--color-purple)",children:[e.jsx(w,{color:"var(--color-purple)",children:"You're All Set!"}),e.jsx(j,{children:"Your Bifrost instance is ready to use. Start creating and managing runes."}),e.jsx("div",{className:"text-center py-8",children:e.jsxs("div",{className:"inline-block px-6 py-4 text-sm",style:{border:"2px solid var(--color-purple)",boxShadow:"var(--shadow-soft)"},children:[e.jsx("p",{className:"font-bold mb-2",children:"Setup Summary"}),e.jsxs("p",{children:["Admin: ",e.jsx("strong",{children:r})]}),e.jsxs("p",{children:["Realm: ",e.jsx("strong",{children:l})]})]})})]})}],x=i.useCallback(async m=>m===2&&!t?g():!0,[t,g]);return e.jsx("div",{className:"min-h-[calc(100vh-56px)] flex items-center justify-center p-6",children:e.jsxs("div",{className:"w-full max-w-2xl",children:[e.jsxs("div",{className:"mb-8 text-center",children:[e.jsx("h1",{className:"text-4xl font-bold tracking-tight mb-2",children:e.jsx("span",{className:"bifrost-logo-text",children:"Bifrost"})}),e.jsx("p",{className:"text-sm uppercase tracking-widest",style:{color:"var(--color-border)"},children:"First-Time Setup"})]}),e.jsx("div",{className:"p-8",style:{backgroundColor:"var(--color-bg)",border:"2px solid var(--color-border)",boxShadow:"var(--shadow-soft)"},children:e.jsx(R,{steps:u,colors:s,onComplete:d,onValidateStep:x})})]})})}function R({steps:r,colors:o,onComplete:l,onValidateStep:n}){const[t,p]=i.useState(0),[a,h]=i.useState(!1),f=t===r.length-1,b=t===0,c=async()=>{if(!a){h(!0);try{await n(t)&&(f?l():p(s=>s+1))}finally{h(!1)}}},g=()=>{b||p(d=>d-1)},v=d=>o[d%o.length]??o[0];return e.jsxs("div",{className:"wizard",children:[e.jsx("div",{className:"wizard-indicators",children:r.map((d,s)=>{const u=s===t,x=s<t,m=s>t;return e.jsxs("div",{className:"wizard-step-indicator",children:[e.jsx("div",{className:"step-number",style:{backgroundColor:u||x?v(s):"#f5f5f5",borderColor:u||x?v(s):"#000000",color:u||x?"#ffffff":"#000000"},children:x?"✓":s+1}),e.jsx("div",{className:"step-title",style:{color:u?v(s):m?"#999999":"#000000",fontWeight:u?"bold":"normal"},children:d.title}),s<r.length-1&&e.jsx("div",{className:"step-connector"})]},d.title)})}),e.jsx("div",{className:"wizard-content",children:r[t]?.content}),e.jsxs("div",{className:"wizard-navigation",children:[!b&&e.jsx(S,{onClick:g,className:"wizard-button wizard-button-back",type:"button",children:"← Back"}),e.jsx(S,{onClick:c,className:`wizard-button ${f?"wizard-button-done":"wizard-button-next"}`,type:"button",disabled:a,children:a?"Processing...":f?"Go to Dashboard →":"Next →"})]}),e.jsx("style",{children:`
        .wizard {
          display: flex;
